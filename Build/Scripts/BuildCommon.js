  ...
  task('genscripts', {
    async: true
        ...
        if (node) {
          ...
          cmds.push(node + " " + dtsGenerator + " --name Atomic --baseDir ./Script/TypeScript --exclude ./Script/TypeScript/dist/*.d.ts --out ./Script/TypeScript/dist/Atomic.d.ts ./Script/TypeScript/*.d.ts ");
