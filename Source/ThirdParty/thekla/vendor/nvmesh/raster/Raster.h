...
namespace nv
{
    ...
    namespace Raster 
    {
        ...
        NVMESH_API bool drawTriangle(bool antialias, Vector2::Arg extents, bool enableScissors, const Vector2 v[3], SamplingCallback cb, void * param);

        // Process the given quad. Returns false if rasterization was interrupted by the callback.
        NVMESH_API bool drawQuad(bool antialias, Vector2::Arg extents, bool enableScissors, const Vector2 v[4], SamplingCallback cb, void * param);
        ...
        // Process the given line. Returns false if rasterization was interrupted by the callback.
        NVMESH_API bool drawLine(bool antialias, Vector2::Arg extents, bool enableScissors, const Vector2 v[2], LineSamplingCallback cb, void * param);
